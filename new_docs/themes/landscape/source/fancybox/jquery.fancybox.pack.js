...
;(function(s, H, f, w) {
    ...
    f.extend(b, {
        ...
        next: function(a) {
            var d = b.current
            d &&
                (r(a) || (a = d.direction.next),
                b.jumpto(d.index + 1, a, "next"))
        },
        prev: function(a) {
            var d = b.current
            d &&
                (r(a) || (a = d.direction.prev),
    ...
    b.helpers.overlay = {
        ...
        open: function(a) {
            ...
            this.overlay
                ...
                : this.create(a)
            this.fixed ||
                (q.bind("resize.overlay", f.proxy(this.update, this)),
                this.update())
            a.closeClick &&
